...
// ═══════════════════════════════════════════════════════════
// Login Page — Sign in with Discord
// ═══════════════════════════════════════════════════════════
    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="animate-fade-in flex w-full max-w-sm flex-col items-center gap-8 rounded-[var(--radius-card)] border border-border bg-surface p-10 shadow-card-hover">
        ...
        <div className="flex h-14 w-14 items-center justify-center rounded-[18px] bg-foreground">
          <Hexagon className="h-7 w-7 text-background" strokeWidth={2.5} />
        </div>

        {/* Title */}
        <div className="text-center">
          <h1 className="text-lg font-bold text-foreground">TrackFlow</h1>
        ...
        <button
          ...
          className="group flex w-full items-center justify-center gap-2.5 rounded-[var(--radius-input)] bg-[#5865F2] px-4 py-3 text-sm font-semibold text-white transition-all duration-200 hover:bg-[#4752C4] hover:shadow-lg active:scale-[0.98]"
        >
          {/* Discord SVG Icon */}
          <svg
            className="h-5 w-5"
